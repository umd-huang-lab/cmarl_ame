...
class BaseWrapper(AECEnv):
    ...
    def __init__(self, env):
        ...
        try:
         ...
         # Not every environment has the .communication_spaces attribute implemented
        try:
            self.communication_spaces = self.env.communication_spaces
        except AttributeError:
            pass
    ...
    def communicate(self, agent):
        return self.env.communicate(agent)
